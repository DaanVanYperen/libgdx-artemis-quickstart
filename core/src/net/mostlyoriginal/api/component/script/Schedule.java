 ...
 *
 * entity.add(new Schedule().wait(0.5f).add(new ExampleComponent()).changedInWorld().wait(1.5f).remove(ExampleComponent.class).changedInWorld().wait(5).deleteFromWorld());
 *
